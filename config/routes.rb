Evaluator::Application.routes.draw do
  ...
  match '/update-question', :to => 'evaluations#updatequestion', :as => 'updatequestion'
  match '/delete-question', :to => 'evaluations#deletequestion', :as => 'deletequestion'
  match '/question_results', :to => 'evaluations#question_results'
  match '/saveresults', :to => 'evaluations#saveresults', :as => 'saveresults'
